...
Born2BeRoot is the first virtualisation project of the common core. Here is the monitoring script I created for the subject. Then, I had to run it regularly, creating a cron task for that.
